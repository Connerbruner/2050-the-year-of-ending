class Boss
{
    ...
    {
        while bill_HP>0:
        enter.print_slow("2069's health", attack.HP1);
        enter.print_slow("2077's health", attack.HP2);
        enter.print_slow("Bill's health", bill_HP);
    ...
    public void attack_bill():
    {
        ...
        attack.HP1 -= hit;
        enter.print_slow("Bill deals ", hit," damage to 2069.");
        ...
        hit = random.randint(5,15);
        attack.HP2 -= hit;
        enter.print_slow("Bill deals ", hit," damage to 2077");
    ...
    def ellon_musk():
    {
        ...
        enter.print_slow("2069's health", attack.HP1);
        enter.print_slow("2077's health", attack.HP2);
        enter.print_slow("Ellon's health", ellon_HP);
    ...
    def attack_ellon():
    {
        ...
        attack.HP1-=damage;
        attack.HP2-=damage;
        enter.print_slow("2069 and 2077 and burned and take ",damage,"damage");
        def double_boss;():
         bill_HP;
         ellon_HP;
        while ellon_HP>0:
        ...
        enter.print_slow("2077's health", attack.HP2);
        enter.print_slow("Bill's health", bill_HP);
        enter.print_slow("Jeff's health",ellon_HP);
    ...
    def Tri_attack():
    {
        ...
        enter.print_slow("Ellon musk:",person,"YOUR ABOUT TO FEEL IT");
        enter.print_slow("Bill Gates: RAGE SLASH");
        num=random.randint(10,20);
        enter.print_slow("Bill Gates deals",num,"Damage and takes",;int(num/3),"damage";)
        enter.print_slow();
        Tri_HP-=;int(num/3)
        damage+=num;
        ...
        enter.print_slow("Ellon musk deals",num+num1+num2,"Damage");
        if people_num==3:
        enter.print_slow("TRI RUSH");
        enter.print_slow("Ellon musk:",person,"YOUR ABOUT TO FEEL IT");
        enter.print_slow("Bill Gates: RAGE SLASH");
        num=random.randint(10,20);
        enter.print_slow("Bill Gates deals",num,"Damage and takes",;int(num/2),"damage";)
        enter.print_slow();
        Tri_HP-=;int(num/2)
        damage+=num;
        enter.print_slow("Jeff bezos: RANDOM FORCE");
    ...
    public void Final()
    {
        ...
        enter.print_slow("Both 2069 and 2077 take ",;int((300-Mark_Zuckerberg)/4),"damage";)
        if Mark==3:
        ...
        if num==1:
        attack.HP1-=5;
        enter.print_slow("2069 takes 5 damage");
        hit=random.randint(0,3);
        if num==2:
        attack.HP2-=5;
        enter.print_slow("2077 takes 5 damage");
        hit=random.randint(0,3);
        if Mark==4:
        ...
        if num==1:
        attack.HP1-=30;
        enter.print_slow("2069 takes 30 damage");
        if num==1:
        attack.HP2-=30;
        enter.print_slow("2077 takes 30 damage");
        hit=random.randint(0,3);
