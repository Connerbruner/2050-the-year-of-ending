class Gotcha
{
    ...
    public void pull1()
    {
        ...
        if expt > 0:
        enter.print_slow("2069 exp", exp.exp1);
        enter.print_slow("2069 exp", exp.exp2);
        enter.print_slow("total exp", expt);
        ...
        enter.print_slow("YOU NEED MORE EXP POOR PERSON");
    ...
    public void roll()
    {
        ...
        enter.print_slow(exp.attack4_teir, "-->", tier);
        if tier == 5:
        ...
        enter.print_slow(exp.attack3_teir, "-->", tier);
        ...
        enter.print_slow(exp.attack1_teir, "-->", tier);
        ...
        enter.print_slow(exp.attack2_teir, "-->", tier);
        if tier == 5:
